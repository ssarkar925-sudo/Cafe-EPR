  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "whatsapp",
        label: "WhatsApp",
        description: "Customer communication and WhatsApp operations",
        href: "/business/whatsapp",
        icon: "whatsapp",
        keywords: ["whatsapp", "chat", "messages", "outbox", "templates", "customer communication"],
        items: [
          { label: "WhatsApp Desk", href: "/business/whatsapp", description: "Customer communication and WhatsApp operations" },
        ],
      },
    ],
    get modules() { return this.items; },
...
export const PAGE_TITLES: Record<string, { title: string; desc: string }> = {
  ...
  "/business/whatsapp": { title: "WhatsApp Desk", desc: "Customer communication and WhatsApp operations" },
