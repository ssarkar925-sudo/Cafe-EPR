export type WorkingItem={label:string;description:string;href:string;shortcut?:string};
...
{id:"cash-bank",label:"Cash & Bank",description:"Liquidity and settlement control",items:[{label:"Cashbook",description:"Daily cash inflow and outflow",href:"/finance/cashbook"},{label:"Reconciliation",description:"Match and clear financial movements",href:"/finance/reconciliation"},{label:"Settlements",description:"Bank, wallet and service settlements",href:"/finance/settlements"}]},
...
{id:"admin",label:"Admin Hub",description:"People, access, security and system configuration",icon:"⚙",modules:[{id:"staff",label:"Staff",description:"Team accounts and permissions",items:[{label:"Staff Accounts & Roles",description:"Manage staff users, roles and permissions",href:"/staff"}]},{id:"security",label:"Security",description:"Account and terminal protection",items:[{label:"Security & 2FA",description:"Credentials, TOTP and terminal controls",href:"/security"}]},{id:"system",label:"System",description:"Store-wide configuration",items:[{label:"System Settings",description:"Core configuration, store profile, themes and automation",href:"/settings"}]}]}
];
