...
drop policy if exists "services all" on public.services;
...
begin
  ...
  -- Quick sales revenue: DISCONTINUED (contributes 0; historical rows preserved).
...
-- COGS: sold qty (minus returned) x cost price (line-level custom cost first, then catalog)
  ...
  -- Quick sale COGS: DISCONTINUED (contributes 0; historical rows preserved).
...
union all
      ...
      from public.transactions
      where status = 'success' and transaction_date between p_from and p_to
      -- Quick sales monthly branches removed (feature discontinued).
    ) raw
...
-- ============================================================================
-- HARDENING (appended; see supabase/hardening.sql)
-- ============================================================================
-- ============================================================================
