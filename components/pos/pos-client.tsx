                    ...
                    {cart.map((l) => (
                      ...
                      >
                        ...
                        <div className="mt-2 flex items-center justify-between gap-2">
                          <div className="flex items-center rounded-xl border border-slate-200/90 bg-white shadow-xs dark:border-white/10 dark:bg-slate-800">
                            <button
                              type="button"
                            ...
                            <span className="w-8 text-center text-xs font-black text-slate-950 dark:text-white">
                              {l.qty}
                            </span>
                            <button
                              type="button"
                          ...
                          <div className="flex items-center gap-1 rounded-xl border border-slate-200/80 bg-white px-2 py-0.5 shadow-xs dark:border-white/10 dark:bg-slate-800">
                            <span className="text-[10px] font-bold text-slate-400">@</span>
                            <input
                              type="number"
                              value={l.rate}
                              onChange={(e) => changeRate(l.key, Number(e.target.value))}
                              className="w-16 bg-transparent text-right text-xs font-black text-slate-900 focus:outline-hidden dark:text-white"
                            />
                          </div>
                          <span className="text-xs font-black text-slate-900 dark:text-white">
                            {inr(l.amount)}
      ...
      {success && (
        ...
        >
          <div className="space-y-5 text-center">
            <div className="relative mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-tr from-emerald-500 to-teal-400 text-white shadow-xl shadow-emerald-500/30 ring-4 ring-emerald-500/15">
            ...
            <div>
              ...
              <p className="text-3xl font-black text-slate-950 dark:text-white tracking-tight">{inr(success.total)}</p>
              {success.change ? (
                <div className="mt-1.5 inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-3 py-1 text-xs font-black text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-300 border border-emerald-200/60 dark:border-emerald-800/40">
                  <span>Change to Return:</span>
              ...
              {success.customer_name && (
                <p className="mt-2 text-xs font-bold text-slate-600 dark:text-slate-300">
                  ...
                  {success.customer_phone ? <span className="text-slate-400 ml-1">({success.customer_phone})</span> : ""}
                </p>
              )}
            </div>

            {/* Tri-Action Post-Sale Dock */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 border-t border-slate-100 pt-4 dark:border-white/5">
              <a
                href={printFormat === "thermal" ? `/receipt/${success.id}` : `/receipt/${success.id}/a4`}
                target="_blank"
                className="flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-3.5 py-2.5 text-xs font-black text-white shadow-md shadow-blue-500/20 hover:bg-blue-700 active:scale-95 transition-all"
              >
                <Printer className="h-3.5 w-3.5" />
                <span>Print {printFormat === "thermal" ? "Thermal (80mm)" : "Invoice (A4)"}</span>
              </a>

              <a
                href={`/receipt/${success.id}/a4`}
                target="_blank"
                className="flex items-center justify-center gap-2 rounded-xl border border-slate-200/90 bg-slate-50 px-3.5 py-2.5 text-xs font-bold text-slate-700 hover:bg-white hover:text-slate-950 hover:shadow-sm active:scale-95 transition-all dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-200"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-3.5 py-2.5 text-xs font-black text-white shadow-md shadow-emerald-600/25 hover:brightness-110 active:scale-95 transition-all"
              >
                <span>💬 WhatsApp</span>
              </button>
            </div>
            ...
            <div className="pt-1">
              <button
                ...
                className="w-full rounded-2xl bg-slate-950 py-3.5 text-xs font-black text-white shadow-lg shadow-slate-900/10 hover:bg-slate-800 active:scale-[0.98] dark:bg-white dark:text-slate-950 dark:hover:bg-slate-100 transition-all"
              >
                Next Customer [Enter] →
              </button>
            </div>
