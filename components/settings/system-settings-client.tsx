  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 lg:px-8">
      <header className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm dark:border-white/10 dark:bg-slate-900">
        <p className="text-xs font-black uppercase tracking-[0.2em] text-blue-600">System Settings</p>
        <h1 className="mt-1 text-3xl font-black tracking-tight text-slate-900 dark:text-white">System Settings</h1>
        <p className="mt-2 max-w-3xl text-sm text-slate-500 dark:text-slate-400">
          Global application settings live here. Operational modules and integrations stay in their owning Hub and are not duplicated here.
        </p>
      </header>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500 dark:text-slate-400">
                Security, Staff &amp; Roles, Audit, AI, WhatsApp and all other operational capabilities are accessed from their canonical Hub in the sidebar. Integration credentials and business-specific configuration remain inside their owning modules.
              </p>
            </div>
