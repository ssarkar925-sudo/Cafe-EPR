    ...
    items: [
      {
        ...
        desc: "Shop name, phone, address & currency",
      ...
      },
      {
        key: "tax",
        label: "Tax & GST",
        desc: "GSTIN registration & default tax rates",
    ...
    items: [
      {
        ...
        desc: "Cash drawer, bank accounts, wallets & cards",
        icon: "M3 9a2 2 0 0 1 2-2h2l2-3h6l2 3h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9ZM3 14h6m0 0 2-2m-2 2 2 2",
      },
      {
        key: "payment-methods",
        label: "Payment Methods",
        desc: "Enable/disable payment options & sort order",
        icon: "M12 8c-2.2 0-4 1.3-4 3s1.8 3 4 3 4-1.3 4-3-1.8-3-4-3ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z",
      },
      {
        key: "quick-favorites",
        label: "Quick Sale Favorites",
        desc: "1-click favorite service buttons on POS",
    ...
    items: [
      {
        ...
        desc: "Banks, AEPS portals, QR codes & Recharge slabs",
        badge: "Essential",
    ...
    items: [
      {
        ...
        desc: "Cloud API, local gateway & zero-click dispatch",
        badge: "Automated",
      ...
      },
      {
        ...
        desc: "Full database snapshots & CSV downloads",
    ...
    items: [
      {
        ...
        desc: "Sign-in locks, audit logs & credentials",
        icon: "M12 22s8-3 8-10V5l-8-3-8 3v7c0 7 8 10 8 10ZM9 12l2 2 4-4",
      },
      {
        key: "other",
        label: "Appearance & Theme",
        desc: "Light, dark or system visual theme",
...
export const tabMeta: Record<string, { title: string; desc: string; group: string }> = {
  ...
  other: { title: "Display Appearance & Theme", desc: "Choose your preferred light, dark, or system visual theme for this device.", group: "Security & Appearance" },
};
