...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "income-report", label: "Income & Margins Breakdown", desc: "Granular revenue, direct costs and net margins by stream", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", directHref: "/reports/income", badge: "Live Margins", badgeColor: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950/70 dark:text-emerald-300", accent: "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/50 dark:text-emerald-400" },
      { key: "cash-bank-report", label: "Cash & Bank Statements", desc: "Multi-instrument reconciliation and expected vs actual balances", icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H6a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3z", directHref: "/reports/cash-bank", accent: "text-blue-600 bg-blue-50 dark:bg-blue-950/50 dark:text-blue-400" },
