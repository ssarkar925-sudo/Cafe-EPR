      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="bento-surface relative overflow-hidden rounded-2xl border p-5 shadow-xs transition-all duration-200 hover:-translate-y-0.5 card-glow-indigo dark:bg-slate-900">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="icon-box-3d flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-sm">
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
          </div>
          <div className="mt-2 font-mono text-3xl font-black text-slate-900 dark:text-white">
            {suppliers.length}
          </div>
        ...
        <div className="bento-surface relative overflow-hidden rounded-2xl border p-5 shadow-xs transition-all duration-200 hover:-translate-y-0.5 card-glow-rose dark:bg-slate-900">
          ...
          <div className="mt-2 font-mono text-3xl font-black text-rose-600 dark:text-rose-400">
            {inr(totalPayable)}
          </div>
