...
export const ALL_AVAILABLE_MODULES: QuickNavItem[] = [
  ...
  { id: "bill-payment", label: "Bill & Recharge Hub", href: "/business/bill-payment", icon: "💳" },
  { id: "recharge", label: "Mobile Recharge", href: "/business/bill-payment?tab=recharge", icon: "🔋" },
  { id: "google-play", label: "Google Play Recharge", href: "/business/bill-payment?tab=google_play", icon: "▶️" },
  { id: "utility-bills", label: "Utility Bill Payment", href: "/business/bill-payment?tab=utility", icon: "🧾" },
  ...
  { id: "trial-balance", label: "Trial Balance", href: "/finance/trial-balance", icon: "⚖️" },
  ...
  { id: "reconciliation", label: "Reconciliation", href: "/finance/reconciliation", icon: "🔍" },
  { id: "opening", label: "Opening Balances", href: "/finance/opening-balances", icon: "🏛️" },
  { id: "dayclose", label: "End-of-Day Close", href: "/finance/day-close", icon: "🔒" },
  { id: "reports", label: "Reports Studio", href: "/reports", icon: "📊" },
  { id: "gst", label: "GST Reports", href: "/reports/gst", icon: "📋" },
  { id: "tax-prep", label: "Tax Preparation / ITR", href: "/reports/tax-preparation", icon: "📋" },
  { id: "audit-log", label: "Security Audit Log", href: "/audit", icon: "📜" },
  { id: "ai", label: "AI Control Center", href: "/ai", icon: "✨" },
  { id: "self-audit", label: "Financial Self-Audit", href: "/ai/self-audit", icon: "🛡️" },
