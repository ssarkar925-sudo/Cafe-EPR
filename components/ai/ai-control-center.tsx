    ...
    return assembleVerifiedContext({
      ...
      taxReport: {
        revenue: {
          ...
          total_operating_revenue: 35989.97,
        },
        cogs: { total_cogs: 0, gross_profit: 35989.97, gross_margin_pct: 100 },
        expenses: { total_active_expenses: 35480, total_cancelled_expenses: 0 },
        pnl: { net_profit: 509.97, net_profit_margin_pct: 1.4, is_profitable: true },
